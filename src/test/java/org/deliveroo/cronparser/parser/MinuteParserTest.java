...
public class MinuteParserTest {
    ...
    @Test
    public void testOneValueSlashOne() {
    ...
    @Test
    public void testIllegalRangeParsingError() {
        List<String> testCases = List.of(
